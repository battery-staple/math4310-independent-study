\begin{section}{Grover's Algorithm}
  With the quantum background out of the way, Grover's algorithm is actually relatively simple.
  It solves a very general problem called database search.
  ...
  \begin{subsection}{Database Search}
    ...
    This is essentially an instance of database search for which $S = Y$ and $f(x) = \begin{cases*}
